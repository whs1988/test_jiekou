...
body = {"LoginForm[username]":"admin",
        "LoginForm[password]":"123456",
        "LoginForm[language]":"zh_cn",
        "LoginForm[rememberMe]":"0",
        "LoginForm[rememberMe]":"1"
}
body1 = {"LoginForm[username]":"admin1",
        "LoginForm[password]":"123456",
        "LoginForm[language]":"zh_cn",
        "LoginForm[rememberMe]":"0",
        "LoginForm[rememberMe]":"1"
...
class TestLogin(unittest.TestCase):
    ...
    def test_login_success(self):
        ...
        result = re.findall("<a href='/bugfree/site/logout'>(.+?)</a>",res.content)
        print type(result)
        print result[0]
        ex = '退出'
        ...
        r2 = self.s.get("http://localhost/bugfree/product/index")
        print r2.content
    ...
    def test_login_usernameerror(self):

        res = self.s.post(url=url,data=body1, headers = header)
